...
function my_assets()
{
    ...
    //     wp_enqueue_script('swiper', get_stylesheet_directory_uri() . '/build/static/js/libs/swiper.min.js',  array('jquery'), '1.1', true);
    ...
    if (is_page_template('page-home.php')) {
      // wp_enqueue_script('sticky-sidebar', get_stylesheet_directory_uri() . '/build/static/js/libs/sticky-sidebar.min.js',  array('jquery'), '1.0', true);   
      wp_enqueue_style('page-home-styles', get_template_directory_uri() . '/build/static/css/pages/page-home.css');
    }
    // if (is_page_template('pdp-shortcode.php')) {
    //   // wp_enqueue_script('sticky-sidebar', get_stylesheet_directory_uri() . '/build/static/js/libs/sticky-sidebar.min.js',  array('jquery'), '1.0', true);   
    //   wp_enqueue_style('pdp-shortcode-styles', get_template_directory_uri() . '/build/static/css/pages/pdp-shortcode.css');
    // }
    // if (is_singular('products')) {
    //   // wp_enqueue_script('sticky-sidebar', get_stylesheet_directory_uri() . '/build/static/js/libs/sticky-sidebar.min.js',  array('jquery'), '1.0', true);   
    //   wp_enqueue_style('single-products-styles', get_template_directory_uri() . '/build/static/css/pages/single-products.css');
    // }
    // if (is_page_template('dynamic-products.php')) {
    //   // wp_enqueue_script('sticky-sidebar', get_stylesheet_directory_uri() . '/build/static/js/libs/sticky-sidebar.min.js',  array('jquery'), '1.0', true);   
    //   wp_enqueue_style('dynamic-products-styles', get_template_directory_uri() . '/build/static/css/pages/dynamic-products.css');
    // }
