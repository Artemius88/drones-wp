  ...
  var he = [function (e) {
    ...
    function c(e, t) {
      ...
      if (e) s.slides.filter(function (e) {
        ...
        e.remove();
      });else for (var _e45 = u; _e45 <= m; _e45 += 1) {
        if (_e45 < x || _e45 > S) {
          (function () {
            var t = L(_e45);
      ...
      for (var _t34 = I; _t34 < z; _t34 += 1) {
        if (_t34 >= x && _t34 <= S) {
          ...
          void 0 === m || e ? P.push(_s18) : (_t34 > m && P.push(_s18), _t34 < u && C.push(_s18));
        }
      }
    ...
    r("beforeInit", function () {
      ...
      removeSlide: function removeSlide(e) {
        if (null == e) return;
        var t = s.activeIndex;
        if (Array.isArray(e)) for (var _a20 = e.length - 1; _a20 >= 0; _a20 -= 1) {
          s.params.virtual.cache && (delete s.virtual.cache[e[_a20]], Object.keys(s.virtual.cache).forEach(function (t) {
            t > e && (s.virtual.cache[t - 1] = s.virtual.cache[t], s.virtual.cache[t - 1].setAttribute("data-swiper-slide-index", t - 1), delete s.virtual.cache[t]);
          })), s.virtual.slides.splice(e[_a20], 1), e[_a20] < t && (t -= 1), t = Math.max(t, 0);
    ...
    function p() {
      ...
      c.forEach(function (e, r) {
        if ("fraction" === s.type && (e.querySelectorAll(ie(s.currentClass)).forEach(function (e) {
          ...
          var _n8 = 1,
              _l7 = 1;
          "horizontal" === _i12 ? _n8 = _r10 : _l7 = _r10, e.querySelectorAll(ie(s.progressbarFillClass)).forEach(function (e) {
    ...
    function u() {
      ...
      if ("bullets" === e.type) {
        ...
        for (var _s23 = 0; _s23 < _a26; _s23 += 1) {
    ...
    function d(e) {
      ...
      }), s.params.loop || s.params.virtual && s.params.virtual.enabled) for (var _e62 = 0; _e62 < i; _e62 += 1) {
        f(s.slidesEl, "[data-swiper-slide-index=\"".concat(t.realIndex + _e62, "\"]")).forEach(function (e) {
          e.classList.add(r);
        });
      } else for (var _e63 = 0; _e63 < i; _e63 += 1) {
        s.slides[t.realIndex + _e63] && s.slides[t.realIndex + _e63].classList.add(r);
      }
            ...
            if (r.freeMode.momentum) {
              if (c.velocities.length > 1) {
                var _e66 = c.velocities.pop(),
                    ...
                    _a30 = _e66.position - _s34.position,
                    _i16 = _e66.time - _s34.time;

                t.velocity = _a30 / _i16, t.velocity /= 2, Math.abs(t.velocity) < r.freeMode.minimumVelocity && (t.velocity = 0), (_i16 > 150 || o() - _e66.time > 300) && (t.velocity = 0);
              } else t.velocity = 0;
              ...
              if (_f && i("transitionEnd", function () {
                ...
                if (_e65 = l ? Math.abs((-_p4 - t.translate) / t.velocity) : Math.abs((_p4 - t.translate) / t.velocity), r.freeMode.sticky) {
                  ...
                  _e65 = _s35 < _a31 ? r.speed : _s35 < 2 * _a31 ? 1.5 * r.speed : 2.5 * r.speed;
                }
      ...
      updateWrapperSize: function updateWrapperSize(e, s) {
        ...
        if (r.virtualSize = (e + n) * t, r.virtualSize = Math.ceil(r.virtualSize / l) - n, r.params.cssMode || (r.wrapperEl.style[r.getDirectionLabel("width")] = "".concat(r.virtualSize + n, "px")), a) {
          ...
          for (var _t46 = 0; _t46 < s.length; _t46 += 1) {
            var _a33 = s[_t46];
            i && (_a33 = Math.floor(_a33)), s[_t46] < r.virtualSize + s[0] && _e68.push(_a33);
          }
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _s37 = 0; _s37 < e.length; _s37 += 1) {
          ...
          _n9.style.opacity = _r16, _n9.style.transform = "translate3d(".concat(_a34, "px, ").concat(_i17, "px, 0px)");
        }
      },
    ...
    ce({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _r18 = 0; _r18 < e.length; _r18 += 1) {
          ...
          var _o8 = _n11.swiperSlideOffset;
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e72 = 0, _s40 = a.length; _e72 < _s40; _e72 += 1) {
          ...
          if (pe(0, _s41).style.transform = _y, _s41.style.zIndex = 1 - Math.abs(Math.round(_u5)), r.slideShadows) {
            ...
            _e73 || (_e73 = me("coverflow", _s41, n ? "left" : "top")), _t49 || (_t49 = me("coverflow", _s41, n ? "right" : "bottom")), _e73 && (_e73.style.opacity = _u5 > 0 ? _u5 : 0), _t49 && (_t49.style.opacity = -_u5 > 0 ? -_u5 : 0);
          }
        }
      },
      setTransition: function setTransition(e) {
        ...
        var _loop2 = function _loop2(_s42) {
          ...
          if (h && f.shadow || !h) {
            ...
            if (!_e75 && f.shadow && (_e75 = me("creative", a)), _e75) {
              ...
              _e75.style.opacity = Math.min(Math.max(Math.abs(_t50), 0), 1);
            }
          }
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _o9 = 0; _o9 < e.length; _o9 += 1) {
          ...
          if (i.slideShadows) {
            ...
            _e78 || (_e78 = me("cards", _d6)), _e78 && (_e78.style.opacity = Math.min(Math.max((Math.abs(_p7) - 0.5) / 0.5, 0), 1));
          }

          _d6.style.zIndex = -Math.abs(Math.round(_c4)) + e.length;
          pe(0, _d6).style.transform = _S;
        }
      },
      setTransition: function setTransition(e) {
        var s = t.slides.map(function (e) {
